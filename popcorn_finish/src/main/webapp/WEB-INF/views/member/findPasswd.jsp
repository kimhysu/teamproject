...
<h2 style="margin-top: 200px;">Password 찾기</h2>

<div class="container">

<form class="form-horizontal"
	  action="findPasswdCheck"
	  method="post"
	  name="frm"
	  id="frm"
	  >
  ...
  <div class="col-sm-offset-4 col-sm-5" id="passwdcheck" name="a">
  </div>
  
  <div class="form-group">
	<div class="col-sm-offset-4 col-sm-5">
      <input type="button" class="btn btn1" name="btnSubmit" id="btnSubmit" value="찾기" onclick="pwCheck()">
