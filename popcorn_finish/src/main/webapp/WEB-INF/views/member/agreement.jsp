...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5" style="text-align: center;">
					<label class="checkbox"> 
    					<input type="checkbox" class="hidden" name="agree" value="1">
						<span class="label-cbk">
						</span>약관에 동의합니다
					</label>
					
<!-- 					<label for="agree"> -->
<!-- 						<input type="checkbox" name="agree" id="agree" value="1">약관에 동의합니다 -->
<!-- 					</label> -->
				
					<button class="btn btn1">회원가입</button>
					<button type="button" class="btn btn1" onclick="history.back()">취소</button>
				</div>
			</div>
		</form>
	</div>
